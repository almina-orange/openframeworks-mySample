//
//  ofxProcessFFTCustom.hpp
//  myWorkspace
//
//  Created by Hiroya Satake on 2018/10/25.
//

#ifndef ofxProcessFFTCustom_hpp
#define ofxProcessFFTCustom_hpp
...
class ProcessFFTCustom {
public:

    ofxEasyFftCustom fft;
    ...
    void setBuffer(vector<float> buff);
    void resetBuffer();
