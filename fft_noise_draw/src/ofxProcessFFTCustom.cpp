...
//---------------------------------------------
void ProcessFFTCustom::calculateFFT(vector<float>&buffer, float _FFTpercentage, int _numFFTbins){
...
//---------------------------------------------
void ProcessFFTCustom::drawHistoryGraph(ofPoint pt, fftRangeType drawType){
...
//---------------------------------------------
void ProcessFFTCustom::drawAvgGraph(ofPoint pt, vector<float> values, ofColor _color){
...
//---------------------------------------------
void ProcessFFTCustom::drawAvgGraphUnScaled(ofPoint pt, vector<float> values, ofColor _color){
        ofEnableAlphaBlending();
        ofPushMatrix();
        ofFill();
        ofSetColor(_color);
...
//---------------------------------------------
void ProcessFFTCustom::drawBars(){
    if(normalize){
    ofPushStyle();
...
//---------------------------------------------
void ProcessFFTCustom::drawDebug(){
    ofPushMatrix();
...
float ProcessFFTCustom::getIntensityAtFrequency(float _freq){
...
float ProcessFFTCustom::getDelta(){
    float prevAvgMaximum = 0;
    float avgMaximum =0;
...
float ProcessFFTCustom::getUnScaledLoudestValue(){
...
float ProcessFFTCustom::getSmoothedUnScaledLoudestValue(){
    return avgMaxSoundOverTime;
}

vector<float> ProcessFFTCustom::getSpectrum(){
    return fftSpectrum;
}

float ProcessFFTCustom::getNoisiness(){
    return noisiness;
}

bool ProcessFFTCustom::getNormalized(){
    return normalize;
}

float ProcessFFTCustom::getLoudBand(){
    return loudestBand; //Todo: this needs to be an average
}

float ProcessFFTCustom::getSuperLowVal(){
    return superLowEqAvg; //this is NOT smoothed, but outputs
}

float ProcessFFTCustom::getLowVal(){
    return lowEqAvg;
}

float ProcessFFTCustom::getMidVal(){
    return midEqAvg;
}

float ProcessFFTCustom::getHighVal(){
    return highEqAvg;
}

float ProcessFFTCustom::getFFTpercentage(){
    return FFTpercentage;
}

float ProcessFFTCustom::getExponent(){
    return FFTpercentage;
}

int ProcessFFTCustom::getNumFFTbins(){
    return numFFTbins;
}

//SETTERS
void ProcessFFTCustom::setFFTpercentage(float _FFTpercentage){
    this->FFTpercentage=_FFTpercentage;
}

void ProcessFFTCustom::setExponent(float _exponent){
    this->exponent=_exponent;
}

void ProcessFFTCustom::setNumFFTBins(int _numFFTBins){
    this->numFFTbins = _numFFTBins;
}

void ProcessFFTCustom::setHistorySize(int _framesOfHistory){
    this->graphMaxSize = _framesOfHistory;
}

void ProcessFFTCustom::setNormalize(bool _normalize){
    this->normalize = _normalize;
}

void ProcessFFTCustom::setVolumeRange(int _volumeRange){
    this->volumeRange = _volumeRange;
}

//--------------------------------------------------------------
void ProcessFFTCustom::setBuffer(vector<float> buff){
    fft.setBuffer(buff);
}

//--------------------------------------------------------------
void ProcessFFTCustom::resetBuffer(){
    fft.resetBuffer();
}